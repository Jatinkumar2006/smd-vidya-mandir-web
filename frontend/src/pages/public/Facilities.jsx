...
const FACILITIES = [
  ...
  {
    icon: '🏡', title: 'Hostel Facility',
    desc: 'Comfortable, secure, and disciplined residential facilities for students. Features nutritious meals, evening study sessions, and 24/7 warden supervision.',
    tags: ['Secure Campus', 'Nutritious Meals', 'Study Sessions'],
  },
  {
    icon: '⚡', title: '24/7 Power & Water Supply',
    desc: 'Uninterrupted electricity with dedicated generator backups and a continuous supply of clean, RO-purified drinking water across the entire campus.',
    tags: ['Generator Backup', 'RO Purified Water', 'Uninterrupted'],
  },
  {
    icon: '🏪', title: '24/7 Campus Canteen',
    desc: 'An all-day, round-the-clock canteen that stocks everything a student might need—from snacks, cold drinks, and ice cream to stationery (pens, notebooks) and daily essentials (soap, shampoo).',
    tags: ['Stationery', 'Snacks', 'Daily Essentials'],
  },
]
    ...
    <>
      ...
      <section style={{ background: '#0a143c', padding: '48px 0' }} className="px-4 md:px-16">
        <div className="responsive-grid-4" style={{ maxWidth: '1160px', margin: '0 auto', textAlign: 'center' }}>
          {[
            { value: settings?.student_count || '500+', label: 'Students Enrolled' },
            { value: '9',    label: 'Major Facilities'  },
