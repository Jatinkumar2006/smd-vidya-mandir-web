...
export default function Careers() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20">
      <Helmet>
        <title>Careers & Job Openings – SMD Vidya Mandir</title>
        <meta name="description" content="Join our team of educators at SMD Vidya Mandir Sikar." />
      </Helmet>
      <PageHeader 
      ...
      <div className="container-max section-padding">
        ...
        <section className="mb-20">
          ...
          <div className="space-y-4">
            {loading ? (
              <LoadingSpinner text="Loading available positions..." />
            ) : openings.length === 0 ? (
